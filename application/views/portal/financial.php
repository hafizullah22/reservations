        ...
        <div class="container text-center text-lg-start">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h1 class=" display-4 fw-bold mb-3 text-center">Financial Information</h1>
                ...
                <div class="card-body">
                    ...
                    <?php foreach ($files as $file): ?>
                        ...
                        <a href="<?= base_url($file->file_path) ?>"
                           target="_blank"
                           class="file-item d-flex align-items-center justify-content-between text-decoration-none p-3 mb-2 rounded">

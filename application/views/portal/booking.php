                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" name="first_name" value="<?=$customer->first_name?>" class="form-control" readonly>
                                    </div>

                                    <div class="col-md-12 mb-3">
                                        <label>Last Name</label>
                                        <input type="text" name="last_name" value="<?=$customer->last_name?>" class="form-control" readonly>
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        <label>Email</label>
                                    ...
                                    <div class="col-md-12 mb-3">
                                     ...
                                     <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" name="phone" value="<?=$customer->customer_type?>" class="form-control" readonly>
                                    </div>
